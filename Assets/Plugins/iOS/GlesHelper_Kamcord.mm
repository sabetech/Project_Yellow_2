...
extern "C" {
    ...
    void _KamcordSetUseFastRender(bool useFastRender)
    {
#if KAMCORD_UNITY_VERSION < 430
        return;
#elif KAMCORD_UNITY_VERSION < 440
        useFastRender = NO;
#endif
        
        [KamcordRecorder setUseFastRender:useFastRender];
    }
...
- (void)onAfterMainDisplaySurfaceRecreate
{
    ...
    if ([KamcordRecorder useFastRender])
    {
...
@implementation UnityAppController (KamcordUnityAppControllerExtension)
